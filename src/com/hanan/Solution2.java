...
//        int[] nums = {1,2,3,4};
        ...
        System.out.println("Number of islands is:::::   " + new Solution2().numIslands(M));
    }
    ...
    public int getRightPathLength(int[][] grid, int i , int j){
                // i is constant and j starting from j and increament
        int pathLenght = 0 ;
        for (int jj = j ; jj< grid[i].length ; jj++){
            pathLenght += grid[i][jj];
        }
        return pathLenght;
    }
    public int getDownPathLength(int[][] grid, int i , int j){
        // i is constant and j starting from j and increament
        int pathLenght = 0 ;
        for (int jj = j ; jj< grid.length ; jj++){
            pathLenght += grid[i][jj];
        }
        return pathLenght;
    }
